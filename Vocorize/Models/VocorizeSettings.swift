...
struct VocorizeSettings: Codable, Equatable {
...
extension SharedReaderKey
	where Self == FileStorageKey<VocorizeSettings>.Default
{
	static var vocorizeSettings: Self {
		Self[
			.fileStorage(URL.documentsDirectory.appending(component: "vocorize_settings.json")),
			default: .init()
		]
	}
}
