...
2. Run `VocorizeTests/scripts/test-unit.sh` for fast feedback (10-30s)
...
|---------|---------|----------|-----------|
| `VocorizeTests/scripts/test-unit.sh` | Mock provider unit tests | 10-30s | Fast iteration, logic validation |
| `VocorizeTests/scripts/test-integration.sh` | Real provider integration tests | 30s-5min | Comprehensive validation |
| `VocorizeTests/scripts/test-integration.sh --clean-cache` | Clean cache integration tests | 2-5min | Full validation, troubleshooting |
| `VocorizeTests/scripts/performance-measurement.sh` | Performance benchmarking | 2-10min | Performance validation, regression detection |
...
2. **Start with unit tests**: `VocorizeTests/scripts/test-unit.sh` for fast feedback
3. **Run integration tests**: `VocorizeTests/scripts/test-integration.sh` to populate cache
4. **Check performance**: `VocorizeTests/scripts/performance-measurement.sh` to validate setup
...
- **Performance reports**: Generated by `VocorizeTests/scripts/performance-measurement.sh`
